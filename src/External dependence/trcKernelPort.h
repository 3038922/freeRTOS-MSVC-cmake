...
#define xQueueGiveFromISR(a, b) TZ__CAT(xQueueGiveFromISR__, uxQueueType) \
(a, b)
...
#define traceTASK_INCREMENT_TICK(xTickCount)                                         \
    if (uxSchedulerSuspended == (unsigned portBASE_TYPE)pdTRUE || xPendedTicks == 0) \
    {                                                                                \
...
#define traceTASK_INCREMENT_TICK(xTickCount)                                          \
    if (uxSchedulerSuspended == (unsigned portBASE_TYPE)pdTRUE || uxPendedTicks == 0) \
    {                                                                                 \
        trcKERNEL_HOOKS_INCREMENT_TICK();                                             \
    }                                                                                 \
    if (uxSchedulerSuspended == (unsigned portBASE_TYPE)pdFALSE)                      \
...
#define traceTASK_INCREMENT_TICK(xTickCount)                                          \
    if (uxSchedulerSuspended == (unsigned portBASE_TYPE)pdTRUE || uxMissedTicks == 0) \
    {                                                                                 \
        trcKERNEL_HOOKS_INCREMENT_TICK();                                             \
    }                                                                                 \
    if (uxSchedulerSuspended == (unsigned portBASE_TYPE)pdFALSE)                      \
